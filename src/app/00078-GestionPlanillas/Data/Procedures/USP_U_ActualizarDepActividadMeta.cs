...
{
    public class USP_U_ActualizarDepActividadMeta
    {
        ...
        public Result Execute()
        {
            ...
            try
            {
                string s_command = "USP_U_ActualizarDepActividadMeta";

                using (var _dbConnection = new SqlConnection(Database.ConnectionString))
                {
                    parameters = new DynamicParameters();
                    parameters.Add(name: "I_DepActividadMetaID", dbType: DbType.Int32, value: I_DepActividadMetaID);
