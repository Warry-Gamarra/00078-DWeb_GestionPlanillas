...
{
    public class USP_IU_GrabarValorExterno
    {
        public DataTable Tbl_ValorExterno { get; set; }
        ...
        public Result Execute()
        {
            ...
            try
            {
                ...
                using (var _dbConnection = new SqlConnection(Database.ConnectionString))
                {
                    ...
                    parameters.Add(name: "Tbl_ValorExterno", value: Tbl_ValorExterno.AsTableValuedParameter("dbo.type_dataValorExterno"));
