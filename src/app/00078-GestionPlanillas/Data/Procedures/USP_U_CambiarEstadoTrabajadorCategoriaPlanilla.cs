...
{
    public class USP_U_CambiarEstadoTrabajadorCategoriaPlanilla
    {
        ...
        public Result Execute()
        {
            ...
            try
            {
                string s_command = "USP_U_CambiarEstadoTrabajadorCategoriaPlanilla";

                using (var _dbConnection = new SqlConnection(Database.ConnectionString))
                {
                    parameters = new DynamicParameters();
                    parameters.Add(name: "I_TrabajadorCategoriaPlanillaID", dbType: DbType.Int32, value: I_TrabajadorCategoriaPlanillaID);
